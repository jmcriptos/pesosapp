...
def upgrade():
    ...
    if dialect == 'sqlite':
        with op.batch_alter_table('pedido', schema=None) as batch_op:
            batch_op.create_foreign_key('fk_pedido_vendedor', 'vendedor', ['vendedor_id'], ['id'])
            batch_op.create_foreign_key('fk_pedido_creado_por', 'vendedor', ['creado_por'], ['id'])
            batch_op.create_foreign_key('fk_pedido_modificado_por', 'vendedor', ['modificado_por'], ['id'])

        with op.batch_alter_table('facturacion', schema=None) as batch_op:
            batch_op.create_foreign_key('fk_facturacion_vendedor', 'vendedor', ['vendedor_id'], ['id'])
            batch_op.create_foreign_key('fk_facturacion_creado_por', 'vendedor', ['creado_por'], ['id'])

        with op.batch_alter_table('recepcion', schema=None) as batch_op:
            batch_op.create_foreign_key('fk_recepcion_creado_por', 'vendedor', ['creado_por'], ['id'])
    else:
...
def downgrade():
    ...
    if dialect == 'sqlite':
        with op.batch_alter_table('recepcion', schema=None) as batch_op:
            batch_op.drop_constraint('fk_recepcion_creado_por', type_='foreignkey')

        with op.batch_alter_table('facturacion', schema=None) as batch_op:
            batch_op.drop_constraint('fk_facturacion_creado_por', type_='foreignkey')
            batch_op.drop_constraint('fk_facturacion_vendedor', type_='foreignkey')

        with op.batch_alter_table('pedido', schema=None) as batch_op:
            batch_op.drop_constraint('fk_pedido_modificado_por', type_='foreignkey')
            batch_op.drop_constraint('fk_pedido_creado_por', type_='foreignkey')
