...
body[data-precios-screen] .mobile-form-label { color: #475569 !important; }
...
body[data-precios-screen] .precios-table tr:hover td { background: #f8fafc; }
...
body[data-precios-screen] .precios-generic-table tbody tr:nth-of-type(odd) { background: #f8fafc; }
